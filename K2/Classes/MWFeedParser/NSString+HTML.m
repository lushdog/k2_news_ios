...
// Strip (some) HTML tags and replace others with formatting for UITextField
- (NSString *)stringByConvertingHTMLToTextFieldContent {
			...
			if ([scanner scanString:@"!--" intoString:NULL]) {
				...
				if ([scanner scanString:@"/" intoString:NULL]) {
					...
					if ([scanner scanCharactersFromSet:tagNameCharacters intoString:&tagName]) {
						...
						replaceTagWithLineBreak = ([tagName isEqualToString:@"br"] ||
