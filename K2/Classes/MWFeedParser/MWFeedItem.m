...
@synthesize title, link, date, updated, summary, content, enclosures,img;
...
-(NSComparisonResult)compare:(MWFeedItem *)feedItem1  {
	return [self.date compare:feedItem1.date];
}
